...
#    Updated: 2025/03/15 12:24:27 by eraad            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_FILES		=	cost/compute_cost_cases.c cost/compute_cost_reverse_rotate.c cost/compute_cost_rotate.c cost/compute_cost.c \
					...
					initialization/init_initialize.c initialization/init_create_array.c \
					...
					utils/find_min_max_indexes.c utils/ft_isdigit.c utils/ft_memcpy.c utils/ft_putchar_fd.c utils/ft_putstr_fd.c utils/ft_strcmp.c utils/ft_strdup.c utils/math_log.c utils/ft_split.c \
					main.c \
					push_swap.c
